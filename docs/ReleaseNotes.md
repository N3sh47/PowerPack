...
### New Features/Improvements
   ...
   - <b><span style={{ color: '#00971D' }}>NEW:</span></b> JSON Generator Transform, Export JSON Task - Allow Placeholder Function usage for <map> tag (e.g. <map src="notes" function="FUN_BASE64ENC" /> or function="sometext <<{$value$},FUN_BASE64>> sometext" in Template mode
